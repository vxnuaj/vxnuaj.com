...
summary: The isosurface, level set, Lₚ Norms, and & Regularization
...
## $L_p$ Norms
<br/>
An $L_p$ norm is a way to caluclate the magnitude of a given mathematical object, say a vector, $\vec{x}$ in $\mathbb{R}^2$.

```math
\vec{x} = \begin{bmatrix}2 \\ 2\end{bmatrix}
```

If I measure it's magnitude via the $L_2$ norm, commonly known as the euclidean distance, I get:

```math

\sqrt{2^2 + 2^2} = 2 = \text{Norm}_2(\vec{x})
...
<br/>
<div align = 'center'>
<img src = 'https://www.researchgate.net/publication/358684032/figure/fig1/AS:11431281179186320@1691161874642/Contours-of-various-norms-a-l2-norm-b-l1-norm-c-lpl-p-quasi-norm.png' width = '450px'></img>
</div>
<br/>
...
<br/>
<div align = 'center'>
<img src = 'https://github.com/vxnuaj/Learning-Arc/raw/main/neural-networks/regularization/img/l1.png' width = '250px'></img>
</div>
<br/>
