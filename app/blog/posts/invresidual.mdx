...
summary: On the effectiveness of Inverted Residual Blocks, in MobileNetV2
image: 'https://preview.redd.it/the-wild-immensity-is-an-oil-painting-i-made-based-on-a-v0-s17crrcrf6nd1.jpeg?auto=webp&s=f2588d90c963e0f1939b3a3697431b94692b16e2'
---
> Note: $\hspace{1.5mm}\mathbb{R}^m < \mathbb{R}^n$
<br/>
...
<br/>
Thereby, for a convolution with a kernel $\mathcal{K_i} \in \mathbb{R}^n$, we can easily reduce the dimensionality of $\mathcal{K}_i$ to $\mathbb{R}^m$, to reduce the computational cost, while still retaining the important features. Such can be the case, given the prior that $H$ embeds features in the subspace of $\mathbb{R}^n$, as $\mathbb{R}^m$.
<br/>
...
<br/>
Therefore you'll still have spatial redundancy after $H$, even when applying a width multiplier $k$, given that $H$ is applied to the **outputs** of a convolution, which in the context of MobileNetV1, have widths of $k \cdot \text{ch}_{out}$.
<br/>
...
<br/>
<div align = 'center'>
<img style = {{width: '400px'}} src = 'https://production-media.paperswithcode.com/methods/Screen_Shot_2020-06-06_at_10.08.25_PM.png'/>
</div>
<br/>
