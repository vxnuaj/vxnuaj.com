---
title: Sparsity of L1 Norms
publishedAt: 2024-09-30
summary: Sparsity.
image: 'https://i.pinimg.com/736x/12/c4/9a/12c49a8994e42e8dc959fc0531b4ff1b.jpg'
---
...
<div align = 'center'>
  <img src='https://www.teraplot.com/images/isosurface-plot-chm.png' width='400px' alt="isosurface plot" />
  <em style={{ fontSize: '10px' }}>
    $w = x^4 + y^4 + z^4 - (x^2 + y^2 + z^2 - 0.4), \hspace{2mm} \text{Level Set: 0 for Blue}$
  </em>
</div>
<br/>
